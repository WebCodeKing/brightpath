...
const Footer = () => {
    ...
    <div className="flex-shrink-0 md:mx-0 mx-auto text-center md:text-left">
      <a className="flex flex-col md:flex-row title-font font-medium items-center md:justify-start justify-center text-white">
         <Image
                      ...
                      />
        <span className="ml-3 text-xl">Brightpath International Study Consultant Pvt Ltd.</span>
      </a>
  ...
  <div className="bg-gray-800 bg-opacity-75">
    <div className="container mx-auto py-4 px-5 flex flex-wrap flex-col sm:flex-row justify-center">
      <p className="text-gray-400 text-sm text-center sm:text-left">© 2026–{new Date().getFullYear()} Brightpath International Study Consultant. All Rights Reserved.
